export default {
  ...
  knowledgeBase: {
    ...
    viewPageOcr: 'Распознанный текст страницы (OCR)',
    noPageOcr: 'На этой странице текст не распознан',
    pageOcrLoadFailed: 'Не удалось загрузить распознанный текст страницы',
    ...
    pdfDocFormat: 'Файлы pdf, doc формата, не более {size} МБ',
...
/example\.(net|org)/`,
  ...
  graphSettings: {
    ...
    templateLoaded: 'Загружен шаблон музейной тематики, при необходимости отредактируйте',
